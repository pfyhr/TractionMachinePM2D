...
def gen_sif(
    ...
    L += [
        ...
        f"  ! NdFeB N45SH: Br={p.B_r:.3f} T, Hci≈2000 kA/m, mu_r={p.mu_r}, sigma={p.magnet_sigma/1e3:.0f} kS/m",
        ...
        "",
        f"  Electric Conductivity = {p.magnet_sigma:.1f}  ! ρ ≈ 1.6 µΩ·m at σ=625 kS/m",
    ...
    if p.magnet_layout == "V":
        L += [
            ...
            "",
            f"  Electric Conductivity = {p.magnet_sigma:.1f}",
